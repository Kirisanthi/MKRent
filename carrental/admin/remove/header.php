    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/MK.jpg" alt="image"/></a> </div>
        </div>
...
$sql ="SELECT FullName,Roles FROM tblusers WHERE EmailId=:email ";
$query= $dbh -> prepare($sql);
   ...
   <i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="contact-us.php">Add Car</a></li>
          <?php } ?>
