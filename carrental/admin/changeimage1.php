...
$sql="update vehiclesdetails set Vimage1=:vimage1 where id=:id";
...
<head>
	...
	<title>MK Travels | Admin Update Image 1</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage1 from vehiclesdetails where vehiclesdetails.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
