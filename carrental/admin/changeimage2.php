...
$sql="update vehiclesdetails set Vimage2=:vimage where id=:id";
...
<head>
	...
	<title>MK Travels | Admin Update Image 2</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage2 from vehiclesdetails where vehiclesdetails.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
