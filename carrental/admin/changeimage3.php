...
$sql="update vehiclesdetails set Vimage3=:vimage where id=:id";
...
<head>
	...
	<title>MK Travels | Admin Update Image 3</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage3 from vehiclesdetails where vehiclesdetails.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
