...
$sql="update vehiclesdetails set Vimage5=:vimage where id=:id";
...
<head>
	...
	<title>MK Travels | Admin Update Image 5</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Vimage5 from vehiclesdetails where vehiclesdetails.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
