...
<script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // Set the min attribute of "From Date" to today's date
            fromDateInput.min = today;

            // Add event listener for changes in the "From Date" input
            fromDateInput.addEventListener('input', function () {
                // Ensure "To Date" is always equal to or greater than "From Date"
...
function submitForm() {
    ...
    // Display the selected date (you can customize this part based on your needs)
    alert("Selected Date: ");

    // Prevent the form from submitting (remove this line if you want to proceed with the form submission)
    return false;
}
</script> -->
</head>
      ...
      <div class="col-md-9">
        <div class="main_features">
          <ul>
            ...
            <div class="price_info" style="color:blue; float:right">
              <h3>£<?php echo htmlentities($result->PricePerDay);?> </h3><h4>Per Day</h4>
            </div>
