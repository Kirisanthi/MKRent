...
$sql="INSERT INTO  testimonialdetails(UserEmail,Testimonial) VALUES(:email,:testimonoial)";
...
<title>MK Travels |Post testimonial</title>
<!--Bootstrap -->
...
<section class="user_profile inner_pages">
  <div class="container">
    <div class="user_profile_info gray-bg padding_4x4_40">
      <div class="upload_user_logo"> <img src="assets/images/MK.jpg" alt="image">
      </div>

      <div class="dealer_info">
        <h6 class="uppercase underline">Post a Feedback</h6>
        <?php if($error){?><div class="errorWrap"><strong style="color:red">ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
          ...
          <form  method="post">
            ...
            <div class="form-group">
              <button type="submit" name="submit" style="float:right" class="btn">Save  <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
      </div>
    </div>
