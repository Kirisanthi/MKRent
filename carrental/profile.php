...
$sql="update usersdetails set FullName=:name,ContactNo=:mobileno,dob=:dob,Address=:adress,City=:city,Country=:country where EmailId=:email";
...
<title>MK Travels | My Profile</title>
<!--Bootstrap -->
...
$sql = "SELECT * from usersdetails where EmailId=:useremail";
$query = $dbh -> prepare($sql);
         ...
         if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          ...
          <div class="row">
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              <button style="float:right;margin-right:15%" type="submit" name="updateprofile" class="btn">Save Changes <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
